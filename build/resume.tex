...
\section{\faPieChart}{Experience}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      \resumeItem {Currently working on the improvement and the migration of billing services within IT.}
      \resumeItem {Worked on Oracle databases and Java Spring APIs with Azure DevOps.}
    \resumeItemListEnd
  \resumeEntryEnd
